  ...
  return (
    <box id="element-toolbar" style={{ flexDirection: 'row', gap: 0 }}>
      ...
      >
        ...
        <text fg={expanded ? COLORS.bg : COLORS.text} style={{ marginLeft: 1 }}>
          Add
        </text>
      </box>
      {expanded && (
  ...
  return (
    ...
    >
        ...
        {selectedNode && onUpdateNode && setFocusedField && (
          ...
          >
            ...
            <box
              ...
              style={{
                backgroundColor:
                  selectedNode.visible !== false ? COLORS.accent : COLORS.bg,
                paddingLeft: 1,
                paddingRight: 1,
              }}
              onMouseDown={() =>
            ...
            >
              <text
                fg={selectedNode.visible !== false ? COLORS.bg : COLORS.muted}
              >
              ...
              {focusedField === 'name' ? (
                ...
                >
                  <input
                    ...
                    onInput={(v) =>
                      onUpdateNode({ name: v } as Partial<Renderable>)
                    }
                ...
                >
                  <text
                    fg={
                      selectedNode.name &&
                      selectedNode.name !==
                        RENDERABLE_REGISTRY[selectedNode.type]?.label
                        ? COLORS.accent
                        : COLORS.muted
                    }
                  >
      ...
      >
        <ElementToolbar
          expanded={addMode}
          onToggle={onToggleAddMode}
          onAddRenderable={onAddRenderable}
        />
      </box>
